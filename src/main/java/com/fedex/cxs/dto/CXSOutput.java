...
/**
 * A CXS Output object contains a list of alert messages along with the API's payload included. This class is intended
 * to be extended by DTO objects
 */
@SuppressWarnings({"unused", "WeakerAccess", "UnusedReturnValue"})
public abstract class CXSOutput {
