...
/**
 * A general alert to be included in the output section of a CXS Envelope. Indicates an auxiliary concern that can be
 * attached to a success message.
 */
...
public class CXSAlert {
    ...
    public CXSAlert(final String code, final String message, final AlertType alertType) {
        this.code = code;
